...
function Section6() {
    ...
    return (
        ...
        <div>
            ...
            <section className="w-full mt-8 mb-12 px-4 sm:px-6">
                <div className="w-[75%] mx-auto relative group">

                    <div className="flex gap-4 bg-white border border-gray-200 rounded-2xl overflow-x-auto hide-scrollbar snap-x snap-mandatory p-4 scroll-smooth">

                        <div className="min-w-60 sm:min-w-[280px] snap-start">
                        ...
                        <div className="min-w-60 sm:min-w-[280px] snap-start">
                            <Card img={drink} name="bella PRO - Barista Elite Espresso Drink Station+ - Stainless Steel" price="89.99" promo="140" />
                        </div>

                        <div className="min-w-60sm:min-w-[280px] snap-start">
                            <Card img={cfs} name="Creality - K2 Plus Printer and CFS Bundle - Space Gray" price="1099.99" oldPrice="1200.00" promo="120" />
                        </div>
